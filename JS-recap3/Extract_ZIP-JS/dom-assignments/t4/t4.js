...
// Pitää vähän selvittää, että miksi toimii näin eikä voi tehä omia funktioita
// Joillekkin jutuille. Joku parempi tapa tähän.

const nykyinenLocation = [];
const distances = [];
...
function success(position) {
  ...
  nykyinenLocation.push(currentLat);
  nykyinenLocation.push(currentLon);

  for (restaraunt of restaurants) {
    let restarauntLat = restaraunt.location.coordinates[0];
    let restarauntLon = restaraunt.location.coordinates[1];
    ...
    restaraunt['distance'] = distance;

    console.log('Etäisyys ' + restaraunt.distance);
  }
...
// Sorttaa array lähimmästä kauimpaan
