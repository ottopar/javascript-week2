...
// Lisää ravintolat leaflet karttaan markereiksi

// Markeria painetaan, näytä nimi <h3> ja address <p>

// Tää toimii, kopsattu vaan ja lisätty omat jutut
...
function success(pos) {
  ...
  for (rest of restaurants) {
    L.marker([rest.location.coordinates[1], rest.location.coordinates[0]])
      .addTo(map)
      .bindPopup('<h3>' + rest.name + '</h3><br><p>' + rest.address + '</p>')
      .openPopup();
  }
